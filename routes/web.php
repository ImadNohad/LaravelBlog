...
Route::get('/category/{category}', [CategorieController::class, "categoryArticles"])->name("categoryArticles");
Route::get('/tag/{tag}', [TagController::class, "tagArticles"])->name("tagArticles");

Route::post('/like/{article}', [LikeController::class, "store"])->name("storeLike");
Route::delete('/like/{article}', [LikeController::class, "destroy"])->name("deleteLike");
...
Route::middleware('auth')->prefix('admin')->group(function () {
    ...
    Route::middleware('admin')->middleware('auteur')->group(function () {
        ...
        Route::put('/articles/comments/{comment}', [CommentaireController::class, "acceptComment"])
            ->name("acceptComment");
